...
\begin{definition}
	...
	\begin{enumerate}[label=\alph*)]
		\item $\sigma$"=кольцом, если $\forall \{A_n\}_{n=1}^{\infty}\subset\F$ выполнено, что
		      $\bigcup\limits_{n=1}^{\infty}A_n\in\F$.
		\item $\delta$"=кольцом, если $\forall \{A_n\}_{n=1}^{\infty}\subset\F$ выполнено, что
...
\begin{definition}
	Множество $I\subset \R$ называется промежутком, если $\forall a,\, b\in I:\: [a,\, b]\subset I$.
	Промежуток $I$ называется конечным, если он ограничен.
...
\begin{definition}
	Семейство $\F\subset \mathcal{P} (X)$ называется полукольцом, если
	\begin{enumerate}[label=\arabic*\degree.]
		\item $\varnothing\in \F$.
...
\begin{definition}
	$K_d=\{I_1\times I_2\times \ldots\times I_d,\, \text{где } I_l\in K_1\quad\forall l = \overline{1..d}\}$, $d\in\N$~--- семейство клеток
	в $\R^d$.
\end{definition}
...
\begin{definition}
	...
	$\mathcal{R}(\F)$ называется кольцом порожденным $\F$.
\end{definition}
