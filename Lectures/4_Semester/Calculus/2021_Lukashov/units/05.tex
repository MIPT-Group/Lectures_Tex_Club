...
\end{linkthm}
\begin{proof}
	Повторим доказательство первой теоремы Коровкина и получим $ {-\varepsilon-\frac{2M}{\sin^2\frac{\delta}{2}}\varphi_x(t)<f(t)-f(x)<\varepsilon+\frac{2M}{\sin^2\frac{\delta}{2}}\varphi_x(t)$, где $\varphi_x(t)=\sin\frac{t-x}{2}$. Проведем доказательство сначала для $t\in(x,x+2\pi]$. Если $t\in(x,x+\delta)$, то $-\varepsilon<f(t)-f(x)<\varepsilon$ в силу равномерной непрерывности
\end{proof}
