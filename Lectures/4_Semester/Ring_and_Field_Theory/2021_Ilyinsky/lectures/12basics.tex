...
\begin{example}
	...
	\begin{center}
		...
		\begin{tikzpicture}
			...
			\node[draw,circle,inner sep=1.5pt,fill,red] at (2, 1) {};
			\node[draw,circle,inner sep=1.5pt,fill,red] at (1, -2) {};
			\node[draw,circle,inner sep=1.5pt,fill,red] at (-2, -1) {};
			\node[draw,circle,inner sep=1.5pt,fill,red] at (-1, 2) {};
		\end{tikzpicture}
		}
	...
	\begin{center}
		\scalebox{0.75}{
			\begin{tikzpicture}
				...
				\node[draw,circle,inner sep=1.5pt,fill,red] at (3 + 1 * \aa, 1 * \bb) {} node [left] at (-1/2, 1.732/2) {$\omega$};
				\node[draw,circle,inner sep=1.5pt,fill,red] at (-3 - 1 * \aa, -1 * \bb) {};
				\node[draw,circle,inner sep=1.5pt,fill,red] at (2 + 3 * \aa, 3 * \bb) {};
				\node[draw,circle,inner sep=1.5pt,fill,red] at (-2 + -3 * \aa, -3 * \bb) {};
				\node[draw,circle,inner sep=1.5pt,fill,red] at (2 + 0 * \aa, -2 * \bb) {};
				\node[draw,circle,inner sep=1.5pt,fill,red] at (-2 + 0 * \aa, 2 * \bb) {};
			\end{tikzpicture}
		}
	\end{center}
...
\begin{example}
	...
	\begin{center}
		\scalebox{0.75}{
			\begin{tikzpicture}
				\clip (-3.8, -2.6) rectangle (3.8, 2.6);
				\begin{scope}[thick,font=\small]
					\draw [->] (-3.8, 0) -- (3.8, 0);
					\draw [->] (0, -2.6) -- (0, 2.6);
