...
\begin{example}
	...
	\begin{center}
		...
		\begin{tikzpicture}
			...
			\node[draw,circle,inner sep=1.4pt,fill,blue] at (0, 1) {};
			\node[draw,circle,inner sep=1.4pt,fill,blue] at (1, 0) {};
			\node[draw,circle,inner sep=1.4pt,fill,blue] at (0, -1) {};
			\node[draw,circle,inner sep=1.4pt,fill,blue] at (-1, 0) {};
	...
	\begin{center}
		\scalebox{0.75}{
			\begin{tikzpicture}
				...
				\draw [->, blue] (0, 0) -- (-0.46, 1.686/2) node [black, below left] {$\omega$};
				\node[draw,circle,inner sep=1.4pt,fill,blue] at (-1/2, 1.732/2) {};
				\node[draw,circle,inner sep=1.4pt,fill,blue] at (1/2, 1.732/2) {};
				\node[draw,circle,inner sep=1.4pt,fill,blue] at (1, 0) {};
				\node[draw,circle,inner sep=1.4pt,fill,blue] at (-1, 0) {};
				\node[draw,circle,inner sep=1.4pt,fill,blue] at (1/2, -1.732/2) {};
