...
\begin{proof}
	Как показано на рисунке ниже, если  $\lambda \nmid z$, то при делении $z$ на 3 с остатком $z$ имеет вид $z = 3u + r$, где $r \in \Z[\omega]^*$ (синим обозначены числа, кратные трем или отличающиеся от кратных трем на обратимый элемент, зеленым "--- кратные $\lambda$):
	\begin{center}
		\scalebox{0.85}{
			\begin{tikzpicture}
	...
	Таким образом, $z = 3u + r$, тогда $z^3 \equiv_p r^3 = \pm 1$.
\end{proof}
