...
\begin{note}
	Мы получили следующую классификацию коммутативных колец:
	...
	\begin{center}
		\scalebox{0.85}{
			\begin{tikzpicture}
				...
				\filldraw[fill=gray, fill opacity=0.15, draw=black] (-6,4.35889894/2 + 1.7320501/2) rectangle (6,4.35889894/2-1.7320501/2);
				\filldraw[fill=gray, fill opacity=0.15, draw=black] (-6,1.7320501/2) rectangle (6,-1.7320501/2);
				\filldraw[fill=gray, fill opacity=0.15, draw=black] (-6,-4.35889894/2 + 1.7320501/2) rectangle (6,-4.35889894/2-1.7320501/2);
				...
				\draw [->, violet] (3.29, 0.82) -- (0.29, -0.18) node [black, below right] {$q$};
