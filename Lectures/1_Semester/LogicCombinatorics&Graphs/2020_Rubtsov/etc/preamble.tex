...
\pagestyle{empty}
%для списков с кастомным алфовитом
\usepackage{enumitem}
...
%zy:
%скобки
\DeclarePairedDelimiter{\delim}{(}{)}
\DeclarePairedDelimiter{\set}{\{}{\}}
\DeclarePairedDelimiter{\braces}{[}{]}
\DeclarePairedDelimiter{\abs}{|}{|}
\DeclarePairedDelimiter{\floor}{\lfloor}{\rfloor}
%действия над множествами
\newcommand{\simdif}{\bigtriangleup}
%красивые буквы
...
%русский алфавит в списках
\makeatletter
\def\rustext#1{\expandafter\@rustext\csname c@#1\endcsname}
\def\@rustext#1{\ifcase#1\or а\or б\or в\or г\or д\or е\or ж\fi}
\makeatother
\AddEnumerateCounter{\rustext}{\@rustext}{ж}
