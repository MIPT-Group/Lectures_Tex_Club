...
\begin{center}
	\begin{tikzpicture}[scale=1]
		...
		\draw[style={dotted}] (c) -- (2.8,0) node[circle, fill, inner sep = 1pt, label={below:$x_0$}] {};
		\draw[style={dotted}] (5.2, 1.1) -- (0,1.1) node[circle, fill, inner sep = 1pt, label={left:$f(x_0)$}] {};
		\draw[style={dotted}] (3.5, 2) -- (0,2) node[circle, fill, inner sep = 1pt, label={left:$f(x)$}] {};
		\draw[style={dotted}] (3.5, 2) -- (3.5,0) node[circle, fill, inner sep = 1pt, label={below:$x$}] {};
