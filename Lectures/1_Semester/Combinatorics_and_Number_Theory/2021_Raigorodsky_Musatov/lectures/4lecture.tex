\begin{proof}
	...
	\begin{center}
		\begin{tikzpicture}
			...
			\draw [blue] (-3, 0) circle[radius=2.2];
			
			\draw [blue] (3, 0) circle[radius=1.7];
			\draw [] (-3, 0) circle[radius=1.7];
			
			\draw [] (3, 0) circle[radius=1.2];
			\draw [blue] (-3, 0) circle[radius=1.2];
			
			\draw[->] (-0.9, 2.25) arc (120:60:2);
			...
			\node[blue] at (3 + 1.6, 1.2) {\scalebox{0.9}{$B_1$}};
			\node[] at (3 + 1.3, 0.7) {\scalebox{0.9}{$B_2$}};
			
			\node[blue] at (-3 - 2.3, 1.7) {\scalebox{0.9}{$A = A_0$}};
			\node[] at (-3 - 1.6, 1.2) {\scalebox{0.9}{$A_1$}};
			\node[blue] at (-3 - 1.3, 0.7) {\scalebox{0.9}{$A_2$}};
