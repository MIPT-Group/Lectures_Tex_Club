...
\hypersetup{				% Гиперссылки
	...
	pdfstartview=FitH,
	pdftitle={Конспект},   % Заголовок
	pdfauthor={Герасимов Федор},      % Автор
...
\newtheorem{sug}{Предположение}[subsection]
...
\graphicspath{{img_src/}}             % Путь к папке с картинками
