...
\newcommand{\CourseName}{Алгебраическая комбинаторика}
\newcommand{\FullCourseNameFirstPart}{\so{АЛГЕБРАИЧЕСКАЯ КОМБИНАТОРИКА}}
\newcommand{\SemesterNumber}{II}
\newcommand{\LecturerInitials}{Балицкий Алексей Михайлович}
