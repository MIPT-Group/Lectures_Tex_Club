...
\newcommand{\convlr}{\rightarrow_{\text{ЛР}}}
...
\newcommand{\CourseName}{Теория функций комплексного переменного}
\newcommand{\FullCourseNameFirstPart}{{ТЕОРИЯ ФУНКЦИЙ КОМПЛЕКСНОГО ПЕРЕМЕННОГО}}
\newcommand{\SemesterNumber}{V}
\newcommand{\LecturerInitials}{Бунаков Андрей Эрикович}
