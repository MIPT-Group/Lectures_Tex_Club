...
% От него работает корень n-й степени, но может полететь все остальное.
\usepackage{fancyhdr}
\fancyhf{}
\lhead{\CourseName}
\rhead{\hyperlink{intro}{\;Назад к содержанию}}
\lfoot{\CourseDate \; ФПМИ МФТИ}
\rfoot{\thepage}
...
\newtheorem{asm}{Предложение}[section]
...
\newtheorem{Exse}{Упражнение}[section]
...
\newcommand{\argt}{\mathrm{arg}}
\newcommand{\argm}{\mathrm{arg}_{\text{гл}}}
...
\newcommand{\abs}[1]{\left|{#1}\right|}      % автоматический размер
\newcommand{\sets}[1]{\left\{{#1}\right\}}      % автоматический размер
\newcommand{\ogamma}{\os{\circ}{\gamma}}