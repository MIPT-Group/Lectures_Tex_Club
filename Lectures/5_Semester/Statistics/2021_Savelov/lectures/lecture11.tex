...
Так как $\displaystyle \dfrac{1}{\sigma ^{2}}\Vert Z\hat{\theta } -Z\theta \Vert ^{2} \ \sim \ \chi _{k}^{2} ,\ \dfrac{1}{\sigma ^{2}} \ \sim \ \Vert X-Z\hat{\theta }\Vert ^{2} \ \sim \ \chi _{n-k}^{2}$, причем эти случайные величины независимы, и
\begin{equation*}
